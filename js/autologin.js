...
function autoLogin() {
	chrome.tabs.query({'active': true, 'currentWindow': true}, function (tabs) {
		...
		if(url == "https://www.facebook.com/"){
			...
			chrome.tabs.executeScript(tabs[0].id, {code: 'document.getElementById("pass").value = "' + password1 + '";'});
		...
		//AMAZON
			...
			chrome.tabs.executeScript(tabs[0].id, {code: 'document.getElementById("ap_password").value = "' + password1 + '";'});
		...
		//BATTLE.NET
			...
			chrome.tabs.executeScript(tabs[0].id, {code: 'document.getElementById("password").value = "' + password1 + '";'});
		...
		//ADOBE
			...
			chrome.tabs.executeScript(tabs[0].id, {code: 'document.getElementById("adobeid_password").value = "' + password1 + '";'});
		...
		//eFollett
			...
			chrome.tabs.executeScript(tabs[0].id, {code: 'document.getElementById("logonPassword").value = "' + password1 + '";'});
